...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\Column]
    private array $roles = []; // Symfony stocke roles sous forme de JSON en base. En le définissant comme private array $roles = [];, on évite l'erreur Cannot assign null.
    ...
    {
        $roles = $this->roles;
        // guarantee every user at least has ROLE_USER : chaque utilisateur a au moins le rôle de 'ROLE_USER'
        $roles[] = 'ROLE_USER';
